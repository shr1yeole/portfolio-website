...
export function GraphicDesign({ projects }: { projects: AdminProject[] }) {
  ...
  const displayGraphicItems = graphicItems.length > 0 ? graphicItems : [
    { id: 'demo-gd-1', title: 'Neon Cyberpunk Poster', category: 'Posters', description: 'Futuristic poster design.', technologies: [], thumbnail: 'https://images.unsplash.com/photo-1626785774573-4b799315345d?w=600&h=600&fit=crop', image: 'https://images.unsplash.com/photo-1626785774573-4b799315345d?w=1200&h=1200&fit=crop', status: 'Published' as const, displayOrder: 0, featured: false, createdAt: '', updatedAt: '' },
    { id: 'demo-gd-2', title: 'Minimalist Brand Identity', category: 'Branding', description: 'Clean branding for a tech startup.', technologies: [], thumbnail: 'https://images.unsplash.com/photo-1600880292203-757bb62b4baf?w=600&h=600&fit=crop', image: 'https://images.unsplash.com/photo-1600880292203-757bb62b4baf?w=1200&h=1200&fit=crop', status: 'Published' as const, displayOrder: 1, featured: false, createdAt: '', updatedAt: '' },
    { id: 'demo-gd-3', title: 'Fashion Social Campaign', category: 'Social Media Creatives', description: 'Instagram campaign assets.', technologies: [], thumbnail: 'https://images.unsplash.com/photo-1611162616305-c69b3fa7fbe0?w=600&h=600&fit=crop', image: 'https://images.unsplash.com/photo-1611162616305-c69b3fa7fbe0?w=1200&h=1200&fit=crop', status: 'Published' as const, displayOrder: 2, featured: false, createdAt: '', updatedAt: '' },
    { id: 'demo-gd-4', title: 'Tech Startup Logo', category: 'Logo Design', description: 'Vector logo design.', technologies: [], thumbnail: 'https://images.unsplash.com/photo-1629757509637-7c99379d6d26?w=600&h=600&fit=crop', image: 'https://images.unsplash.com/photo-1629757509637-7c99379d6d26?w=1200&h=1200&fit=crop', status: 'Published' as const, displayOrder: 3, featured: false, createdAt: '', updatedAt: '' },
    { id: 'demo-gd-5', title: 'Product Photography', category: 'Photography', description: 'Studio shots of cosmetics.', technologies: [], thumbnail: 'https://images.unsplash.com/photo-1521556662401-522ab73ce3bb?w=600&h=600&fit=crop', image: 'https://images.unsplash.com/photo-1521556662401-522ab73ce3bb?w=1200&h=1200&fit=crop', status: 'Published' as const, displayOrder: 4, featured: false, createdAt: '', updatedAt: '' },
  ];
